...
const getWorkspaceStats = async (req, res) => {
  try {
    ...
    // get total projects and projects with tasks and sort by createdAt
    ...
    //get total tasks, tasks in progress, tasks completed, tasks to do
    ...
    // get tasks trends for the last 7 days
    const taskTrendsData = [
      { name: "Sun", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Mon", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Tue", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Wed", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Thu", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Fri", completed: 0, toDo: 0, inProgress: 0 },
      { name: "Sat", completed: 0, toDo: 0, inProgress: 0 },
    ];
    ...
    // Populate task trends data with tasks from the last 7 days
